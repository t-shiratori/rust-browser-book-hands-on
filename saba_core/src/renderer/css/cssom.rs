...
mod tests {
    ...
    use super::{CssParser, Declaration, QualifiedRule};
    ...
    fn test_one_rule() {
        ...
        declaration.set_value(super::ComponentValue::Ident("red".to_string()));
    ...
    fn test_multiple_rules() {
        ...
        declaration1.set_value(super::ComponentValue::StringToken("Hey".to_string()));
        rule1.set_declarations(vec![declaration1]);

        let mut rule2 = QualifiedRule::new();
        rule2.set_selector(super::Selector::TypeSelector("h1".to_string()));
        let mut declaration2 = Declaration::new();
        declaration2.set_property("font-size".to_string());
        declaration2.set_value(super::ComponentValue::Number(40.0));
        let mut declaration3 = Declaration::new();
        declaration3.set_property("color".to_string());
        declaration3.set_value(super::ComponentValue::Ident("blue".to_string()));
